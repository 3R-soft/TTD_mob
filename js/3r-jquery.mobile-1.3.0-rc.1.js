			...
			$.ajax({
				...
				error: function( xhr, textStatus, errorThrown ) {
					...
					if ( settings.showLoadMsg ) {
						...
						// hide after delay
						setTimeout( $.mobile.hidePageLoadingMsg, 5000 );	// vreme trajanja poruke o grešci (bilo je 1500)  -  3R
					}
...
//				meta.attr( "content", disabledZoom );	//	3R - izbaceno zbog flikera prilikom koriscenja "transition" izmedju strana
...
//				meta.attr( "content", enabledZoom );	//	3R - izbaceno zbog flikera prilikom koriscenja "transition" izmedju strana
