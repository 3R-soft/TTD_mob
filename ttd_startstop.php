...
<body>
  <!-- StartStop -->
  <div id="startstop" data-role="page" data-fullscreen="true" data-theme="a">
              ...
              <td>
                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="starttasters">
                  ...
                  <tr>
                    <td width="50%" class="menuok">
					  <?php 
						echo '<a href="ttd_findcar.php?id= ';
						echo $myrow['id'];
						echo '"> ';
						echo '<img src="images/start_panic.png" width="100%" alt="panic"></a> ';
					  ?>
					</td>
