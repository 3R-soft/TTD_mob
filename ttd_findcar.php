...
<body>
  <!-- FindCar -->
  <div id="findcar" data-role="page" data-fullscreen="true" data-theme="a">
	  ...
	  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr><td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="0"><!--style="max-width:600px"-->
            <tr>
              <td width="6%"><img src="images/all4.gif" alt="all4" width="100%"></td>
              <td>&nbsp;</td>
              <td width="6%"><img src="images/all4.gif" alt="all4" width="100%"></td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="starttasters">
                  <tr>
                    <td class="startstop">
                      <a href="#"><img src="images/startstop-engine.png" alt="STARTSTOP" width="100%"></a>
                    </td>
                  </tr>
                  <tr>
                    <td width="50%" class="menunok"><a href="#"><img src="images/start_lock.png" width="100%" alt="unlock"></a></td>
                    <td width="50%" class="menuok">
					  <a href="#pincode" data-rel="popup" data-position-to="window" data-transition="false">
						<img src="images/start_unlock.png" width="100%" alt="unlock">
					  </a>
                    </td>
                  </tr>
                  <tr>
                    <td width="50%" class="menuok"><a href="#" data-rel="back"><img src="images/start_panic.png" width="100%" alt="panic"></a></td>
                    <td width="50%" class="menunok"><a href="#"><img src="images/start_trunk.png" width="100%" alt="trunk"></a></td>
                  </tr>
                </table>
              </td>
              <td width="6%"><img src="images/all4_blank.gif" alt="all4" width="100%"></td>
	...
	<!-- PinCode -->
    <div id="pincode" data-role="popup" data-theme="a" data-overlay-theme="a" class="ui-corner-all" style="padding:0px 20%">
	  <form enctype="multipart/form-data" action="pincode.php" method="get">
		<div style="margin:20px -20%">
		  <input type="hidden" name="id" value="<?php echo $id;?>" />
		  <h3>Enter your PIN code</h3>
		  <label for="pincode" class="ui-hidden-accessible">enter your PIN code:</label><!-- skriveno -->
		  <input type="password" name="pincode" id="pincode" placeholder="pin code" class="pincode" />
		<br>
		  <input type="submit" name="submit" data-theme="f" value="OK" />
		</div>
	  </form>
	</div><!-- /PinCode -->
